<div id="cmtx_perm_{{ comment.id }}" class="cmtx_comment_box cmtx_comment_layout_one cmtx_clear" data-cmtx-comment-id="{{ comment.id }}" itemprop="comment" itemscope itemtype="https://schema.org/Comment">
