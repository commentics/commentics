<div id="cmtx_perm_{{ comment.id }}" class="cmtx_comment_box cmtx_comment_layout_two cmtx_clear" data-cmtx-comment-id="{{ comment.id }}" itemscope itemtype="https://schema.org/Comment">
            ...
            <div class="cmtx_user_and_rating_area">
                ...
                @if show_headline and comment.headline
                    <div class="cmtx_headline_area">
                        <span class="cmtx_headline_text">{{ comment.headline }}</span>
                    </div>
                @endif
