...
class MainInstall2Model extends Model {
	...
	public function createTableSettings($site_name, $site_domain, $site_url, $security_key, $session_key, $encryption_key, $site_id, $time_zone, $commentics_folder, $commentics_url, $backend_folder, $ssl_certificate) {
		...
		$this->db->query("INSERT INTO `" . CMTX_DB_PREFIX . "settings` SET `category` = 'theme', `title` = 'jquery_ui_source', `value` = ''");
