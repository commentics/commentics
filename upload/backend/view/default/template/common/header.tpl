					...
					<?php if (!$has_restriction || ($has_restriction && in_array('help', $viewable_pages))) { ?>
						<li><a><span class="fa fa-question-circle"></span><?php echo $lang_menu_help; ?></a>
							...
							<ul>
								...
								<?php if (!$has_restriction || ($has_restriction && in_array('help/faq', $viewable_pages))) { ?> <li><a href="https://www.commentics.org/support/" target="_blank"><?php echo $lang_menu_help_faq; ?></a></li> <?php } ?>
								...
								<?php if (!$has_restriction || ($has_restriction && in_array('help/license', $viewable_pages))) { ?> <li><a href="https://www.commentics.org/license/" target="_blank"><?php echo $lang_menu_help_license; ?></a></li> <?php } ?>
							</ul>
						</li>
					<?php } ?>
