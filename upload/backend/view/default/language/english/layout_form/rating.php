<?php
// Heading
$_['lang_heading']				= 'Rating';

// Description
$_['lang_description']			= '<p>These settings relate to the layout of the rating field.</p>';
...
// Hint
$_['lang_hint_enabled']			= 'Whether the rating field should appear on the form.';
