<?php
// Heading
$_['lang_heading']					= 'Security';

// Description
$_['lang_description']				= '<p>These settings relate to the security of the script.</p>';

// Entry
$_['lang_entry_check_referrer']		= 'Check Referrer:';
$_['lang_entry_check_config']		= 'Check Config:';
$_['lang_entry_check_honeypot']		= 'Check Honeypot:';
$_['lang_entry_check_time']			= 'Check Time:';
$_['lang_entry_check_ip_address']	= 'Check IP Address:';
$_['lang_entry_check_csrf']			= 'Check CSRF:';
...
$_['lang_hint_check_csrf']			= 'Whether to check for CSRF on the comment form. The check is mandatory in the admin area.';
