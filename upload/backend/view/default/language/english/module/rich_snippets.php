...
$_['lang_hint_other']          = 'Enter a type not in the list above. Make sure it is a valid type from schema.org. Note that some types require adding extra mark-up.';
