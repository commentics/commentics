...
<div class="tool_clear_cache_page">
    ...
    <form action="index.php?route=tool/clear_cache" class="controls" method="post">
        <div class="fieldset">
            ...
            <a class="hint" onmouseover="showhint('<?php echo $lang_hint_database; ?>', this, event, '')">[?]</a>
        </div>
        ...
        <div class="fieldset">
            ...
            <a class="hint" onmouseover="showhint('<?php echo $lang_hint_modification; ?>', this, event, '')">[?]</a>
        </div>

        <div class="fieldset">
            <label><?php echo $lang_entry_template; ?></label>
            <input type="checkbox" name="template" value="1" <?php if ($template) { echo 'checked'; } ?>>
            <a class="hint" onmouseover="showhint('<?php echo $lang_hint_template; ?>', this, event, '')">[?]</a>
        </div>
